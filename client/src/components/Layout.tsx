...
export type NavPage = 'dashboard' | 'parsers' | 'jobs' | 'settings' | 'docs'
...
export function Layout({ children }: Props) {
  ...
  const activePage: NavPage =
    pathname.startsWith('/parsers') || pathname.startsWith('/editor')
      ? 'parsers'
  ...
  const ThemeIcon =
    settings.theme === 'system' ? MonitorIcon : settings.theme === 'dark' ? SunIcon : MoonIcon
