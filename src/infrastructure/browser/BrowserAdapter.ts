...
): BrowserAdapter<import('puppeteer').Page>
export function createBrowserAdapter(
  browserType?: 'playwright' | 'playwright-stealth' | undefined,
  settings?: StepSettings,
): BrowserAdapter<import('playwright').Page>
export function createBrowserAdapter(
  browserType?: BrowserType,
  settings?: StepSettings,
): BrowserAdapter<import('playwright').Page | import('puppeteer').Page>
export function createBrowserAdapter(
  browserType?: BrowserType,
  settings?: StepSettings,
  ...
  if (browserType === 'playwright-stealth')
    return new PlaywrightStealthAdapter(settings?.launchOptions, settings?.contextOptions)
